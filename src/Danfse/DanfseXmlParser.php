...
final class DanfseXmlParser
{
    ...
    private function extrairTributacaoIbsCbs(DOMXPath $xpath): array
    {
        ...
        return [
            ...
            'p_red_aliq_uf' => $this->float($xpath, $ibsPath . '/n:valores/n:uf/n:pRedAliqUF'),
            ...
            'p_red_aliq_mun' => $this->float($xpath, $ibsPath . '/n:valores/n:mun/n:pRedAliqMun'),
            ...
            'p_red_aliq_cbs' => $this->float($xpath, $ibsPath . '/n:valores/n:fed/n:pRedAliqCBS'),
    ...
    private function extrairValorTotal(DOMXPath $xpath): array
    {
        ...
        return [
            ...
            // <vTotalRet> é computado pelo SEFIN e vive na NFS-e autorizada
            // (TCValoresNFSe), entre vISSQN e vLiq — NÃO no DPS. Sem fallback:
            // se o SEFIN não devolver, fica null (campo "-" na DANFSe).
